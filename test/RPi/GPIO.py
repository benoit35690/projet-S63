# -*- coding: utf-8 -*-
# TEST UNITAIRE
# module importé depuis l'URL suivante
# http://raspberry-python.blogspot.com/2013/01/rpigpio-limposteur.html
# fonctions modifiées set_low_event et set_high_event
import intern
